...
const VERSION = 'etccm-v6';
const CORE = ['./', 'index.html', 'styles.css', 'programas.js', 'catalogo.js', 'config.js', 'mentores.js', 'experiencias.html', 'eventos.html', 'mentores.html', 'admin.html', 'assets/logo-emprendimiento-ieegl.png', 'assets/logo-emprendimiento.png', 'assets/rayo-azul.png', 'assets/rayo-blanco.png',
